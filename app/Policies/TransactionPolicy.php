...
class TransactionPolicy
{
    ...
    public function update(User $user, Transaction $transaction, Workspace $workspace): bool
    {
        return $this->hasWriteAccess($user, $workspace);
    }

    public function delete(User $user, Transaction $transaction, Workspace $workspace): bool
    {
