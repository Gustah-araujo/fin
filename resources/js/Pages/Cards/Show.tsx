        ...
        <AuthenticatedLayout>
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    ...
                    <Button asChild>
                        <Link
                            href={route('card-expenses.create', {
                            ...
                            <Card>
                                <CardHeader>
                                    <div className="flex items-center justify-between">
                                        <CardTitle>
                                            Fatura Atual —{' '}
                                            {openBill.period_label}
                                        </CardTitle>
                                        <Badge>{openBill.status_label}</Badge>
                                    </div>
                                    <p className="text-2xl font-bold">
                                        {formatCurrency(openBill.total_amount)}
                                    </p>
                                    <p className="text-xs text-muted-foreground">
                                        Fechamento: {openBill.closing_date} ·
                                        Vencimento: {openBill.due_date}
                                    </p>
                                </CardHeader>
                                <CardContent>
