...
export default function BillShow({ bill, card, accounts }: Props) {
    ...
    function handlePay(e: React.FormEvent) {
        ...
        form.post(
            route('bills.pay', { workspace: workspace.uuid, bill: bill.uuid }),
            {
    ...
    return (
        <AuthenticatedLayout>
            <div className="max-w-3xl mx-auto space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-semibold tracking-tight">
                            Fatura {card.name} — {bill.period_label}
                        </h1>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <p className="text-xs text-muted-foreground">
                            Fechamento: {bill.closing_date} · Vencimento:{' '}
                            {bill.due_date}
                        </p>
                        {bill.paid_at && (
                ...
                {bill.status === 'paid' && (
                    <Button variant="outline" onClick={handleUnpay}>
                        Desfazer Pagamento
                    </Button>
                )}
            </div>
